<footer class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="text-gray-400 mb-4">
                    Système de gestion de rendez-vous moderne et efficace pour optimiser 
                    votre organisation et améliorer l'expérience utilisateur.
                </p>
            </div>
            ...
            <div>
                ...
                <div class="space-y-3 text-gray-400">
                    ...
                    <div class="flex items-center">
                        ...
                        <span>contact@rdvmanager.com</span>
                    </div>
                    <div class="flex items-center">
                        <svg class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {{ date('Y') }} RDV Manager. Tous droits réservés.</p>
        </div>
    </div>
</footer>